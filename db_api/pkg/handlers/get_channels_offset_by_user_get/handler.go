package get_channels_offset_by_user_get
...
func (h *Handler) Handle(w http.ResponseWriter, r *http.Request) {
	...
	offsets, err := h.DB.GetUserSubscriptionOffsets(ctx, userID)
	if err != nil {
		http.Error(w, "failed to get subscription offsets: "+err.Error(), http.StatusInternalServerError)
		return
	}
